...
class OnlineSalesRegisterCollector:
    ...
    def get_telephone_number(self, telephone_number):
        """
        Возвращает полный номер телефона в формате +7XXXXXXXXXX.

        Args:
            telephone_number (str): номер телефона без кода страны (например, '9123456789')

        Returns:
            str: полный номер телефона с кодом +7
        """
